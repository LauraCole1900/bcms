      ...
      { pageReady === true &&
        isAuthenticated && (
          <Container>
            ...
            <ErrorModal conference={conference} confname={conference.confName} urlid={confId} urltype={formType} errmsg={errThrown} attname={attendee.givenName + " " + attendee.familyName} show={showErr} hide={e => handleHideErr(e)} />
